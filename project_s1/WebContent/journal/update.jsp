...
JournalBean journalBean = dao.getBoard(num);

// 검색한 하나의 글 정보를 얻기
int DBnum = journalBean.getNum();
String DBId = journalBean.getId();
String DBTitle = journalBean.getTitle();
String DBContent = "";

if(journalBean.getContent() != null){
	
	DBContent = journalBean.getContent().replace("\r\n","<br>");
}
