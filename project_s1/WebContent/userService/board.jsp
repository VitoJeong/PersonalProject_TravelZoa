...
<%
	...
	if(count > 0){
		...
		for(int i=0; i<list.size(); i++){
			...
			int beanNum = bBean.getNum();
			String beanTitle = bBean.getTitle();
			String beanId = bBean.getId();
			String beanDate = new SimpleDateFormat("yyyy.MM.dd").format(bBean.getDate());
			int beanCount = bBean.getCount();
%>
